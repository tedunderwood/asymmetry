...
import kld_calc_worker_20c as kcw
...
meta = pd.read_csv('../meta/filtered20csample.tsv', sep = '\t')
data = pd.read_csv('../model/20th_doc_topics.tsv', sep = '\t', index_col = 'docid')
...
matrixfile = '../results/' + outputname + 'matrix.tsv'
